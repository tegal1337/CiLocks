...
#                         echo >&2 "${m}Cilocks require wget but it's not installed. Install it. Aborting.${n}"
#                         exit 1
#                     }
...
#                             echo >&2 "${m}Cilocks require unzip but it's not installed. Install it. Aborting.${n}"
#                             exit 1
#                         }
...
#         command -v php >/dev/null 2>&1 || {
#             echo >&2 "${lh}Cilocks require php but it's not installed. Install it. Aborting.${n}"
#             exit 1
#         }
...
#         else
#             command -v unzip >/dev/null 2>&1 || {
#                 echo >&2 "${lh}Cilocks require unzip but it's not installed. Install it. Aborting.${lh}"
#                 exit 1
#             }
#             command -v wget >/dev/null 2>&1 || {
#                 echo >&2 "${lh}Cilocks require wget but it's not installed. Install it. Aborting.${lh}"
#                 exit 1
#             }
